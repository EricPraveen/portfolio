...
export default function Footer() {
  return (
    <footer className="mt-20 w-full" style={{ borderTop: "1px solid rgba(255,255,255,0.08)", background: "#141417" }}>
      <div className="container-custom py-16 lg:py-20">

        {/* Top CTA */}
        <div style={{ borderBottom: "1px solid rgba(255,255,255,0.08)", paddingBottom: "2.5rem", marginBottom: "2.5rem" }}>
          <h2 style={{
        ...
        {/* 3 columns */}
        <div className="grid gap-12 lg:grid-cols-[1.15fr_0.95fr_0.9fr] lg:gap-8">
        ...
        {/* Bottom bar */}
        <div className="mt-8 flex flex-col gap-3 pt-5 text-xs sm:flex-row sm:items-center sm:justify-between" style={{ borderTop: "1px solid rgba(255,255,255,0.08)", color: "#55556a" }}>
